        ...
        <Col xs={24} md={20} lg={16} xl={14}>
          ...
          <Card className='welcomebanner-card' bordered={false}>
            <Typography.Paragraph className='welcomebanner-text'>
              We are dedicated to providing compassionate, personalized, 
              and world-class medical care that puts you and your family’s health first. 
              Explore our comprehensive range of services, meet our highly skilled and caring expert team, 
              and experience a healthcare approach centered on your well-being and comfort every step of the way.
          ...
          <Carousel autoplay dots>
            {[Slide1, Slide4, Slide5].map((img, index) => (
              <div key={index} className='welcomebanner-slide'>
                <img src={img} alt={`Slide ${index + 1}`} className='welcomebanner-image' />
              </div>
            ))}
          </Carousel>
        </Col>
