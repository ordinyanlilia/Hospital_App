    ...
    >
      <Col span={12}>
        ...
        <Typography.Paragraph>
          World-class care for everyone. Our expert team of doctors and modern
          facilities ensure the best healthcare experience.
        </Typography.Paragraph>
        <Button type="primary" size="large" onClick={handleBookAppointments}>
          Book Appointment
        </Button>
      </Col>
      <Col span={12}>
